...
<nav class="navbar navbar-expand topbar mb-4 static-top shadow">
  ...
  <!-- Topbar Navbar -->
  <div class="text-white small ml-auto" id="clock2"></div>
  ...
  <div class="text-white small" id="clock"></div>
  <script type="text/javascript">
    function showTime() {
      var a_p = "";
      var today = new Date();
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item dropdown no-arrow ">
      <a class="nav-link dropdown-toggle" href="../index.php" id="userDropdown" role="button" data-toggle="dropdown"
        ...
        <span class="mr-2 d-none d-lg-inline text-white small">ADMIN KELOMPOK 09</span>
        <img class="img-profile rounded-circle" src="assetsbaru/undraw_profile.svg">
      </a>
